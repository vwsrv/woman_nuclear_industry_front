...
export const MediatekaPage: React.FC = () => {
  ...
  const [visibleMoviesCount, setVisibleMoviesCount] = useState(9);
  ...
  return (
    <div className={styles.mediateka}>
      ...
      <div className={styles.mediateka__block}>
        ...
        <div className={styles.mediateka__videosContainer}>
          {movieList.slice(0, visibleMoviesCount).map(movie => (
            <a
              key={movie.id} // Добавьте уникальный ключ для каждого элемента
              className={styles.mediateka__item}
              href={movie.videoUrl}
              target="_blank"
            >
