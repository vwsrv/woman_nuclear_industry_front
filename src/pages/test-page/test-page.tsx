...
export const TestPage: React.FC = () => {
  ...
  return (
    <div style={{display: 'flex', flexDirection: 'column', justifyContent: 'center', alignItems: 'center'}}>
      ...
      <div style={{margin: '30px 0', width: '100%', display: 'flex', justifyContent: 'center', alignItems: 'center'}}>
        <Textarea
          className='textarea'
          label='Адрес:'
          value={textareaValue}
